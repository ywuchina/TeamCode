...
if __name__ == '__main__':
    ...
    dataset = Semantic3D(args.labeled_point, args.gen_pseudo, args.retrain)
    ...
    if Mode == 'train':
        ...
        chosen_snapshot = -1
        logs = np.sort(
            [os.path.join('results/checkpoints', f) for f in os.listdir('results/checkpoints') if f.endswith(args.exp)])
