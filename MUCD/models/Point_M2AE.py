...
from segmentation.pointnet2_utils import PointNetFeaturePropagation_
...
class Point_M2AE(nn.Module):
    ...
    def forward(self, pts, eval=False, **kwargs):
        ...
        if eval:
            ...
            for i in range(len(x_vis_list)):
                x_vis_list[i] = x_vis_list[i].transpose(-1, -2).contiguous()
            ...
            # x_global_feature = x_max_feature + x_avg_feature  # 672 * 2 + 64
