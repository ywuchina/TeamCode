...
def get_args():
    ...
    # print('Path(args.config)=>', Path(args.config))
    # print('Path(args.config).stem=>', Path(args.config).stem)
    # Path(args.config) = > cfgs / pretrain.yaml
    # Path(args.config).stem = > pretrain
